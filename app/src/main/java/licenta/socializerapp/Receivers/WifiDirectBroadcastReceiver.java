package licenta.socializerapp.Receivers;
...
import licenta.socializerapp.activities.StartChatActivity;
...
//			Log.v(TAG, "WIFI_P2P_PEERS_CHANGED_ACTION");
	...
	public void activateGoToChat(String role){
		if(mActivity.getClass() == StartChatActivity.class){
			((StartChatActivity)mActivity).getGoToChat().setText("Start the chat "+role);
			((StartChatActivity)mActivity).getGoToChat().setVisibility(View.VISIBLE);
			((StartChatActivity)mActivity).getSetChatName().setVisibility(View.VISIBLE);
			((StartChatActivity)mActivity).getSetChatNameLabel().setVisibility(View.VISIBLE);
			((StartChatActivity)mActivity).getDisconnect().setVisibility(View.VISIBLE);
			((StartChatActivity)mActivity).getGoToSettings().setVisibility(View.GONE);
			((StartChatActivity)mActivity).getGoToSettingsText().setVisibility(View.GONE);
		}
	}
